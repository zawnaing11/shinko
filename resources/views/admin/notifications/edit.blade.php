...
<div class="contentbar">
    <form class="form-update" action="{{ route('admin.notifications.update', $notification->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $notification->title) }}" maxlength="{{ config('const.default_text_maxlength') }}" placeholder="タイトル"  required>
                                    @error('title')
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="publish_end_datetime" name="publish_end_datetime" class="datetime-format form-control @error('publish_end_datetime') is-invalid @enderror" value="{{ old('publish_end_datetime', $notification->publish_end_datetime ? date('Y-m-d H:i', strtotime($notification->publish_end_datetime)) : "") }}" placeholder="YYYY-MM-DD HH:mm" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="ri-calendar-line"></i></span>
                                        </div>
